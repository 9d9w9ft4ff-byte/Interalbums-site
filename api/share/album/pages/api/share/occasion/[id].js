// pages/api/share/occasion/[id].js
// Paste into: 9d9w9ft4ff-byte/Interalbums-site → pages/api/share/occasion/[id].js
// Same pattern as pages/api/share/album/[slug].js
...
export default async function handler(req) {
  ...
  const ogTitle = `${bandName} — ${occasionTitle}`;
  const ogDesc  = [
