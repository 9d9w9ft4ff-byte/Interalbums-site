...
<head>
  ...
  <meta property="og:url" content="https://interalbums.com/api/share/album/${slug}" />
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .site { font-size: 0.7rem; letter-spacing: 0.2em; color: #7a7a85; margin-bottom: 0.5rem; text-transform: uppercase; }
    .band { font-size: 1.1rem; color: #C9A84C; margin-bottom: 0.25rem; }
    .album { font-size: 1.6rem; font-weight: bold; margin-bottom: 0.75rem; }
    .desc { font-size: 0.85rem; color: #7a7a85; line-height: 1.5; }
  </style>
</head>
<body>
  <div class="card">
